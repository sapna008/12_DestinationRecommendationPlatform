...
import { MapPin, DollarSign, Users, Compass, Calendar, Hotel, Clock } from 'lucide-react';
...
const SurveyForm = () => {
  ...
  return (
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div 
        className="max-w-3xl mx-auto backdrop-blur-sm rounded-2xl shadow-xl p-8 transform transition-all duration-300 hover:scale-[1.01] border border-white/20"
        style={{
